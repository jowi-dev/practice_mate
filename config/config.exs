...
config :practice_mate, PracticeMateWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: PracticeMateWeb.ErrorHTML, json: PracticeMateWeb.ErrorJSON],
    layout: false
  ],
...
config :practice_mate, PracticeMate.Mailer, adapter: Swoosh.Adapters.Local
